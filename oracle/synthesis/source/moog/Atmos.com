...
c******************************************************************************
     ...
     .             fbarklem, fbarklemUV
      ...
      real*8       transitions(2500,7), strong_transitions(2500,7),
     .             logepsilon_abundances(100,2),
     .             photospheric_structure(100,10) 

      common/atmos/debug, t, theta, tkev, tlog, 
     .             pgas, ne, nhtot, numdens,
     .             molweight, vturb, vturb_absolute, scont,
     ...
     .             fluxintopt, plotopt, dampingopt, specfileopt, 
     .             linfileopt, printstrong, linecount, oldcount,
     .             scatopt, transitions, strong_transitions,
     .             logepsilon_abundances, photospheric_structure
